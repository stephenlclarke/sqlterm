# Contributing To sqlterm

Thank you for helping improve `sqlterm`. Contributions are easiest to review when they are focused, tested, documented, and safe for protected branches.

If this repository is a fork, send changes that belong upstream to the upstream project first. Use this fork for changes that are specific to this repository.
